...
//                     <div className="p-8 md:p-24 pt-4 w-full">
//                         <h2 className="text-4xl font-bold text-left playfair_display md:text-5xl mb-3">About Us</h2>
//                         {/* Add your About Us content here */}
//                         <p className="pt-3 jakarta">Aman Mithaiwala Pvt. Ltd. is a family-owned business dedicated to preserving the rich heritage of traditional Indian sweets. Established in [Year], we craft authentic and delectable sweets using time-honored recipes and techniques.
...
//                         <h2 className="text-4xl font-bold text-left md:text-center mb-5 playfair_display md:text-5xl">Our Jouney</h2>

//                         <div className="items-center justify-between jakarta text-sm lg:flex">
        ...
        <>
            ...
            <div  className="my-1 py-2 flex flex-col w-full border-y-2 border-black dark:border-neutral-800 rounded-xl bg-neutral text-white lg:flex-row overflow-hidden">
                <div className="w-full flex flex-col items-center justify-center pt-3 space-x-4">
                    <div data-aos="fade-up" className="p-8 md:p-24 pt-4 w-full text-center">
                        <h2 data-aos="fade-right" className="text-4xl font-bold text-center playfair_display md:text-6xl mb-3">About Us</h2>
                        ...
                        <p data-aos="fade-up" className="pt-3 jakarta text-left text-xl">
                            ...
                            At Aman Mithaiwala Pvt. Ltd, our skilled artisans meticulously prepare each sweet with passion and dedication, ensuring every bite is a delightful journey through the flavors of India.
                        </p>
                    </div>
